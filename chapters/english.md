...
この事件はあくまで、「機械翻訳の結果」という著作権の扱いが不明瞭な物を、「権利を自分達が持っていると主張する前提の物」の一部として含めたことが問題となったケースです。不具合や要望を報告する場面で機械翻訳の結果を使ったとしても、直ちに同じレベルで問題になるということは、まずないでしょう。ですが、翻訳はコントリビュートのきっかけとして挑戦しやすい分野で、近接する領域にあると筆者は考えています。報告の次のステップとして翻訳に取り組む際には、個々で述べたことを心に留め置いておいてもらえればと思います。
