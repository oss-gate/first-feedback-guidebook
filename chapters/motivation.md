...
[^proprietary]: 「proprietary」とは「占有権のある」という意味で、「誰でも自由に使えて改変もできる物」と対置して使われる形容詞です。ソフトウェアの場合、DRMのような技術的手段や、エンドユーザーライセンスの条件のような法的手段によって、改変・再利用を禁止している物を「プロプライエタリソフトウェア」と呼びます。
