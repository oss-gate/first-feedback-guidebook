...
2019年に、とある日本人が個人で開発したOSSがイスラエルのセキュリティ企業の目に留まり、買収された上で作者自身もその専任担当者として雇用されるに至った[^trivy]、という話が話題になりました。
...
実績が見えないのに何故かITイベントでの登壇が多い有名な人を揶揄する「IT芸人」なんて言い方がありますが、OSSにフィードバックした事実は間違いなく「目に見える実績」ですし、その内容からは後述するような様々な情報を読み取れます。*「この人は口先だけじゃない」と信用してもらえる材料*を積み重ねる手段として、OSSへのフィードバックは非常に有効です。
...
別の角度から見ると、*たくさんフィードバックの機会があること自体が、自身の挑戦の多さのバロメーターになる*とも言えます。
