...
この2つを比較したとき、自由なソフトウェアという考え方は、より社会運動的な性質が強いと言えます。
...
囲い込み戦略には、それによって莫大な利益を上げるプレイヤーが生まれ、その利益を元に先進的な研究開発がなされることで、より文化や技術が発展する、という側面があることは事実です。しかし、それが行き過ぎると、世の中を良くすることに関わりたければ大プレイヤーの一員になるしか選択肢がなく、その選別に漏れた人には下働きしか道がない、ということにもなりかねません。

本書を読まれた方の中には、OSSといえばGAFA[^gafa]のような大企業が作ってくれる物をありがたく使うものだ、という認識を持っていた人もいるのではないでしょうか。そのような声を見かけたことが、実は筆者にとっての、本書執筆の最大の動機でした。
...
そして、あなたが自由を手に入れられたときには是非とも、後に続く人へも自由のバトンを渡して頂ければと思います。
