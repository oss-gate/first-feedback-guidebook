...
筆者自身は、当初は「みんなで製品の改善に協力できるって素晴らしい！」と考えて（まさに上記の「オープンソース」の理念に価値を感じて）、MozillaやFirefoxに関わっていました。

しかし、Firefoxのアドオンの開発を通じて、*自分が感じた細かな不満・つまずきを、自分の努力次第で解消できる*という経験を重ねる中で、筆者は「自由」の意義をより強く感じるようになっていきました。

また、身のまわりに知識を持つ人はおらず、教えてくれる人に接触する術も無かったために、筆者は*ソフトウェアそのものから学ぶ*しかありませんでした。これは改めて考えてみると、*ソフトウェアのソースコードを自由に触れないと、筆者は『学ぶこと』すらままならなかった*、ということにもなります。
