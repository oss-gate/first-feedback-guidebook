...
筆者自身は、当初は「みんなで製品の改善に協力できるって素晴らしい！」と考えて（まさに上記の「オープンソース」の理念に価値を感じて）、MozillaやFirefoxに関わっていました。しかし、Firefoxのアドオンを開発して、*自分が感じた細かな不満・つまずきを、自分の努力で解消する*という経験を重ねる中で、筆者は徐々に、*自分は自由を手に入れていっている*ということに気がつき始めました。

また、身のまわりに知識を持つ人がおらず、教えてくれる人に接触する術も無かった筆者にとって、*学びはソフトウェアそのものから得る*しかありませんでした。*ソフトウェアのソースコードを自由に触れないと、筆者は『学ぶこと』すらままならなかった*と言えます。

ソフトウェアから学びを得る自由をくれた人達がいたおかげで、筆者は、自分で物事を変えていける自由を手に入れられました。そのような体験を持つ筆者にとって、自由が制限されることは耐え難いことで、自由を推進することは、後に続く人達への「恩送り」だと考えています。

ですので、本書をご覧になったあなたにとって、もしこれが自由の価値に目を向ける機会となり、自由を手に入れるきっかけとなってくれれば、それに勝る喜びはありません。
