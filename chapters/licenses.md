...
ともかく、この4つの自由をすべて備えたソフトウェアのことを、GNUでは「自由なソフトウェア」と呼んでいます。定義の内容から、すべての自由なソフトウェアはOSSと言えますが、OSSの中には自由なソフトウェアとは言えない物もあります。
...
目的が異なるため、それぞれの立場を極端に突き詰めると、以下のようにも言うことができます。
...
筆者自身は、当初は「みんなで製品の改善に協力できるって素晴らしい！」と考えてMozillaやFirefoxに関わっていました。しかしその過程で、

* 製品の改善に協力するには、そもそも知識がいる。
* 知識を身に付けるためには学ぶ必要があるが、教えてくれる人に接触する術は無く、学べる教材はソフトウェアそのものしかない。
* ソフトウェアを自由にいじれないと、学ぶことすらままならない。
* 困ったときに、自分が抱えているようなニッチなニーズに応えてくれる人はいない。
* ソフトウェアを自由にいじれないと、自助努力での解決もままならない。

という気付きを得て、より重要なのは「自由」の方だと考えるようになりました。
