...
OSSプロジェクトでは、技術仕様をWiki形式で公開している場合があります。OSSプロジェクトによっては、いわゆる「公式サイト」が存在せず、GitHubのプロジェクトページのWikiがそれに相当する扱いになっていることもあります。また、そのように特定のOSSプロジェクトに付随するWikiだけでなく、Mozillaが運営するMDN Web Docs[^mdn-web-docs]のように、Webサイト全体がWikiになっていることもあります。
