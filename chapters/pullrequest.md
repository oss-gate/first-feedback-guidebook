...
「そんなこと、元々の開発者と同じレベルの技術力が無いとできないじゃないか！」と思うでしょうか？　いいえ、そうとは限りません。確かに、まったく新しいモジュールを追加するような変更になると、元の開発者と同等の技術力が必要になってきます。ですが、「既存のモジュールの、特定の関数の中だけの変更」というように、変更が必要な範囲が充分に狭いなら、そこまでの技術力は必ずしも必要ありません。

多くのOSSは、全体に渡って超絶技巧が凝らされているということはありません。部分部分だけを取り出して見れば、どこにでもあるようなごく普通のコードの集積です。全体を見てしまうと「こんな高度な物、理解できない！」としか感じられなくても、末端の関数一つ一つを取り出して見れば、以外と単純な作りになっているものです。というのも、OSSで「難解で分かりにくいコード」を書くのは開発者にとっても自殺行為で、メンテナンス性が高く可読性の高いコードにしておかないと開発者自身が困るから、という事情があるからです。
