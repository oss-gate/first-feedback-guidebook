...
なお、本書ではGitなどのバージョン管理ツールやGitHubのようなサービスの使い方そのものは解説しません。GitHub自体まだ使ったことがないという方は、先にこれらの使い方を把握しておいて下さい。筆者的には、初心者にも分かりやすい解説に定評のある湊川あい氏によるWeb連載の「[マンガでわかるGit](https://next.rikunabi.com/journal/tag/webdesign-manga/)」や、その増補改訂版の書籍「わかばちゃんと学ぶ Git使い方入門」がおすすめです。
