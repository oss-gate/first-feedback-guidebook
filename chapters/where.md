...
ユーザーコミュニティとは、ユーザー同士の交流や相互に手助けを行い合う場です。一般的に「コミュニティ」と言うとこちらを指す場合も多いです。

一方、「開発者コミュニティ」という言葉には馴染みが薄い人も多いかもしれません。OSSでは、開発者は「特定の会社に雇われた開発チーム」といったカッチリした集団であるとは限らず、有志の開発者達の集まりだったり、個人の主要開発者と協力者の集まりだったり、雇用された開発者と有志の開発者が入り交じった雑多な集まりだったりもします。そういったさまざまな場合を総称して言う表現が「開発者コミュニティ」です。例えば、Chromiumの開発者コミュニティはGoogle Chrome開発チームを中心とつつ、Microsoftなど他社の開発者、個人参加の開発者など幅広い参加者を抱えています。
...
（図：さまざまなコミュニティと連絡ツール
  ...
  * 開発者コミュニティ
    ...
    - 開発者向けメーリングリスト
    - 開発者向けグループウェア
一人の人が複数に属している事もある、という図）

ここで悩ましいのが、*「ユーザーコミュニティ」と「開発者コミュニティ」のどちらに報告するべきなのか*という点です。OSS Gateワークショップでも、初めてフィードバックをしようとしているビギナー参加者から、「こんな簡単な・くだらないレベルの事を開発者に報告してもいいの？」「フォーラムとイシュートラッカーのどっちに報告すればいいの？」と質問されることがあります。
...
この表を見て分かるとおり、ユーザーフォーラムとイシュートラッカーでは「得られる成果」と「得られない成果」がちょうど逆の関係になっています。もちろん、ユーザーフォーラムでの報告がきっかけで製品が改善されることも、その逆に、イシュートラッカーの中で提示された情報によって報告者の問題が解決されることも、どちらも確かにあります。が、それらはあくまで「運がよければそうなる」という臨時の副産物（ボーナス）に過ぎないのです。

さて、改めて考えてみましょう。*あなたが望むのは「今遭遇しているつまずきが一刻も早く解決されること」でしょうか？　それとも「ソフトウェアが改善され、将来のバージョンで同じつまずきが起こらなくなること」でしょうか？*　後者に少しでも関心を持っているなら、イシュートラッカーへ――つまり開発者コミュニティへとフィードバックする頃合いだと言えます。

一般的には、OSSへのフィードバックというと開発者コミュニティへフィードバックすることを言います。なので、本書において単に「フィードバック先」と書く場合は、開発者コミュニティの連絡ツール、具体的にはイシュートラッカーや開発者向けメーリングリストなどを想定することにします。
...
開発者コミュニティは、「お客さまと、開発者」ではなく「後輩であまり詳しくない開発者と、先輩で詳しい開発者」の交流の場です。関わる人にはある程度の技術的な知識が要求されます。報告者に全く知識が無いという場合、問題自体の深刻度がよほど高いと判断されれば、開発者もなんとか原因究明に必要な情報を報告者から引き出そうとして手厚く手助けする事もあります。しかし、それだけの手間をかけるのは割に合わないとなれば、残念ながらそれ以上の手助けはなされません。「お客さまとして歓待され手厚いサポートを受けられるはず」と期待していると、肩透かしを食らうどころか、不快な思いをする羽目にもなってしまうでしょう。
