...
フィードバックを行う最初の時点では、皆さんはきっと「失敗しないだろうか？」とビクビクしているでしょうから、これらのことを意識する必要はあまり無いかもしれません。それよりも、気をつけないといけない度合いが高いのは、*フィードバックに対する開発者の反応が芳しくないものだった場合や、フィードバックを何度も重ねて「常連」になり、他の報告者に何かアドバイスをしようとした場合など*です。これについては、「フィードバックした後のこと」をテーマとした10章以降で詳しく述べることにします。
