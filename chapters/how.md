...
言葉での説明にせよ、画像や動画での説明にせよ、再現手順は*自分で「細かすぎるかも」と思うくらいに細かく説明するように意識しましょう*。というのも、*報告に不慣れな人ほど、荒く・情報が不足した報告をしてしまいがち*だからです。
...
なお、最小の再現条件・手順を特定できたら、その現象がそのソフトウェアの*「最新開発版」でも同じ手順で再現するかどうか*を調べ直すのがおすすめです。もしあなたが使っていた版が少し古い版で、最新開発版では現象が再現しないのであれば、その問題はすでに修正されている可能性があるからです。

ただ、最新かどうかに関わらず「開発版」では再現せず「リリース版」では再現するという場合もあります。確実に「この問題はすでに修正された」と判断できる材料がないのであれば、問題が見過ごされてしまわないことを優先して、「このバージョンで再現した」という情報を添えて報告しておくことを、筆者はおすすめしたいです。
