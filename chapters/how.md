...
しかし、そうは言っても、たとえば影響が疑われるソフトウェアが100件も列挙されていては、調査の有効な助けになるとは言い難いです。開発者側でそれらをすべて導入するのも、適切に設定するのも、現実的には不可能でしょう。
...
[^actual-result-in-screencast]: スクリーンキャストの動画で説明したのであれば、実際の結果はその中に自然と含まれることになります。

どちらの場合でも、*自分で「細かすぎるかも」と思うくらいに細かく説明するように意識する*とよいのは、再現手順の書き出し方と共通です。なるべく読み手の想像に任せずに済むように、できる限り正確に説明するようにしましょう。
