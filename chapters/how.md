...
すでに業務でたくさんバグレポートを書いている人にとっては、特に目新しい話ではないので、この章は読み飛ばしていただいても大丈夫です。逆に、まだ業務でバグレポートを書くということを経験したことがない人や、いいレポートを書けずに困っているという人には、この章は業務の上でも役に立つかもしれません。
...
ただ、このような判断は非常に難しいものですし、経験者でもアテが外れることはよくあります。また、*違う環境でも似た問題が再現するが、調べてみたら表面的には似ていても問題の内容は全く別だった*、という「他人の空似」に遭遇してしまうこともあります。そうなってしまうと、報告をする上では余計な回り道にしかなりません。皆さんはなるべくこのような横着をせず、現象の再現手順を特定するときには*実行環境やソフトウェアのバージョンを揃え、余計なソフトウェアは入っておらず、ユーザー設定も存在しない、という状態から始めることを原則としましょう*。


### コラム：普段使いの環境を失わない方法はないか？

「まずまっさらな環境で再現を試みよう」と述べましたが、個人でフィードバックを試みる場合、PCを1台しか持っていないため「まっさらな環境を作るためには普段使いの環境を消去しないといけない」ということがあり得ます。そういう場合でも、諦めるのはまだ早いです。
